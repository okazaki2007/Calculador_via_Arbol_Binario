...
/**
 * Clase editada extendidamente por Jeff, tomada del internet referenciado en la documentacion externa
 * @author ploks, Jeff
 */
public class Gui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ARBOL DE EXPRESION", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new Font("Tahoma", 1, 10))); // NOI18N
        jPanel2.setOpaque(false);

        jPanel3.setBackground(new Color(255, 255, 255));
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Operaciones", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new Font("Tahoma", 1, 10))); // NOI18N
        jPanel3.setOpaque(false);

        botonInsertar.setBackground(new Color(255, 255, 255));
        botonInsertar.setFont(new Font("Tahoma", 1, 12)); // NOI18N
        ...
        try {
            ...
            if (this.simulador.insertar(dato)) {
               ...
               simulador.inOrden();
                ...
                double out=eval.calculation(dato+"+0.0");
              System.out.format("\n"+"Resultado\n"+ "%.3f %n", out);
    ...
    private void repintarArbol() {
        ...
        this.jInternalFrame2.add(simulador.getPaint(), BorderLayout.CENTER);
    }
